...
function App() {
  ...
  const mod350ChangeHandler = (selectedValues: number[]): void => {
  ...
  const mod8000ChangeHandler = (selectedValues: number[]): void => {
  ...
  const mod20002ChangeHandler = (selectedValues: number[]): void => {
    ...
    <>
      <div className="p-8">
        <div className="grid grid-cols-3 gap-8 mb-8">
          <FilterComponent values={mod350Filters} selectedValues={mod350SelectedFilters} changeHandler={mod350ChangeHandler} />
          <FilterComponent values={mod8000Filters} selectedValues={mod8000SelectedFilters} changeHandler={mod8000ChangeHandler} />
          <FilterComponent values={mod20002Filters} selectedValues={mod20002SelectedFilters} changeHandler={mod20002ChangeHandler} />
        </div>
        <TableComponent />
      </div>
    </>
